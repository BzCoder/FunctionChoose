...
import me.bzcoder.app.R; import me.bzcoder.cityservice.mainpage.FunctionItem; import me.bzcoder.cityservice.mainpage.ServiceEnum;
 ...
 * @date : 2019/1/7 11:22
 */
public class JiaXingCityServiceData implements CityData {
    private List<FunctionItem> data;

    public JiaXingCityServiceData() {
        data = new ArrayList<>();
        data.add(new FunctionItem("自然气象", "", 0, ServiceEnum.TITLE));
        data.add(new FunctionItem("天气预报", "https://app.zjzwfw.gov.cn/zjjssdk/tqyb/weather.jsp?citycode=101210301&123", R.mipmap.city_service_weather_forecast, ServiceEnum.FOUR_ONE_LINE));
		...
		data.add(new FunctionItem("潮汛查询", "http://www.hnxw.net/app/tqcx/cx.html", R.mipmap.city_service_tide_query, ServiceEnum.FOUR_ONE_LINE));
