 ...
 * @date : 2019/1/7 11:22
 */
public class JinHuaCityServiceData implements CityData {
    private List<FunctionItem> data;

    public JinHuaCityServiceData() {
        data = new ArrayList<>();
        data.add(new FunctionItem("自然气象", "", 0, ServiceEnum.TITLE));
        data.add(new FunctionItem("天气预报", "https://app.zjzwfw.gov.cn/zjjssdk/tqyb/weather.jsp?citycode=101210901&123", R.mipmap.city_service_weather_forecast, ServiceEnum.FOUR_ONE_LINE));
