 ...
 * @date : 2019/1/7 11:22
 */
public class LiShuiCityServiceData implements CityData {
    private List<FunctionItem> data;

    public LiShuiCityServiceData() {
        data = new ArrayList<>();
        data.add(new FunctionItem("自然气象", "", 0, ServiceEnum.TITLE));
        data.add(new FunctionItem("天气预报", "https://app.zjzwfw.gov.cn/zjjssdk/tqyb/weather.jsp?citycode=101210801&123", R.mipmap.city_service_weather_forecast, ServiceEnum.FOUR_ONE_LINE));
		...
		data.add(new FunctionItem("社保服务", "https://app.ls12333.cn/ServiceHallForWechat/Index", R.mipmap.city_service_social_insurance_service, ServiceEnum.FOUR_ONE_LINE));
