 ...
 * @date : 2019/1/7 11:22
 */
public class QuZhouCityServiceData implements CityData {
    private List<FunctionItem> data;

    public QuZhouCityServiceData() {
        data = new ArrayList<>();
        data.add(new FunctionItem("自然气象", "", 0, ServiceEnum.TITLE));
        data.add(new FunctionItem("天气预报", "https://app.zjzwfw.gov.cn/zjjssdk/tqyb/weather.jsp?citycode=101211001&123", R.mipmap.city_service_weather_forecast, ServiceEnum.FOUR_ONE_LINE));
