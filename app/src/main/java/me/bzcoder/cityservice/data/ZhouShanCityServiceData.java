 ...
 * @date : 2019/1/7 11:22
 */
public class ZhouShanCityServiceData implements CityData {
    private List<FunctionItem> data;

    public ZhouShanCityServiceData() {
        data = new ArrayList<>();
        data.add(new FunctionItem("自然气象", "", 0, ServiceEnum.TITLE));
        data.add(new FunctionItem("天气预报", "https://app.zjzwfw.gov.cn/zjjssdk/tqyb/weather.jsp?citycode=101211401&123", R.mipmap.city_service_weather_forecast, ServiceEnum.FOUR_ONE_LINE));
        ...
        data.add(new FunctionItem("舟山民政", "http://m.zssmz.net/col.jsp?id=111", R.mipmap.city_service_zhoushan_civil_administration, ServiceEnum.FOUR_ONE_LINE));
