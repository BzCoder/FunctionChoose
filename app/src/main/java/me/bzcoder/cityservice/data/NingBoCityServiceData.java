 ...
 * @date : 2019/1/7 11:22
 */
public class NingBoCityServiceData implements CityData {
    private List<FunctionItem> data;

    public NingBoCityServiceData() {
        data = new ArrayList<>();
        data.add(new FunctionItem("自然气象", "", 0, ServiceEnum.TITLE));
        data.add(new FunctionItem("天气预报", "https://app.zjzwfw.gov.cn/zjjssdk/tqyb/weather.jsp?citycode=101210401&123", R.mipmap.city_service_weather_forecast, ServiceEnum.FOUR_ONE_LINE));
        ...
        data.add(new FunctionItem("图书馆", "https://nbstsg.yyhj.zjzwfw.gov.cn/ningboviews/ningboindex.html", R.mipmap.city_service_library, ServiceEnum.FOUR_ONE_LINE));
